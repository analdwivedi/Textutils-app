...
export default function TextForm(props) {
    ...
    const onCopy = () =>{
        ...
        props.show_Alert("everything is copied!", "danger");
    }
    ...
    return (
        <>
            <div className='container' style={props.mode} >
                <h3>{props.heading}</h3>
                <div className="mb-3">
                    <label htmlFor="myemail" className="form-label">Email Address Here</label>
                ...
                <button disabled={text.length === 0} className="btn btn-success mx-2 my-2" onClick={onDownClick}>Convert to Lowercase</button>
                ...
                <button disabled={text.length === 0} className="btn btn-dark mx-2 my-2" onClick={onCopy}>Copy</button>
            </div>
